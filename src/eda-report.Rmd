...
knitr::opts_chunk$set(echo = FALSE,comment = NA, warning = FALSE, message = FALSE, cache = TRUE, fig.height = 3)
...
```{r}
  ...
  p1 <- ferr_op_melt %>% ggplot() + 
    ...
    labs(title = "Ferric OP Concentration at Dosing",
         x = "Date",
         y = "Hourly OP (mg/L)") +
    scale_color_discrete(name = "Location", labels = c("Dosing Station", "Effluent")) +
